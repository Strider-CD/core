  ...
  return [{
    ...
    handler(request, reply) {
      ...
      try {
        ...
        Drone.update(decoded.parent, { platform: filter.requiredResource }).then(data => console.log('Updated drone specs')).catch(error => console.error('Drone update error:', error));
      } catch (e) {
        console.error(e);
      }
